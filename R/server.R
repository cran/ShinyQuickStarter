.shiny_quick_starter_server <- function() {
  ...
  server = function(input, output, session) {
    ...
    observeEvent(input$button_export_settings, {
      ...
      if (!.check_project_options(paths())[["delete_possible"]]) {
        ...
        text_2 = paste0("<pre style='text-align: left'>", 
                        paths()[["directory"]], 
                        "</pre>")
        text_3 = paste0("<pre style='text-align: left; height: ; overflow: auto;'>",
    ...
    observeEvent(input$button_create_project_structure, {
      ...
      text_2 = paste0("<pre style='text-align: left'>", 
                      paths()[["directory"]], 
                      "</pre>")
      text_3 = paste0("<pre style='text-align: left; height: 150px; overflow: auto;'>",
    ...
    observeEvent(input$button_update_project_structure, {
      ...
      text_2 = paste0("<pre style='text-align: left; height: 75px; overflow: auto;'>",
      ...
      text_4 = paste0("<pre style='text-align: left; height: 75px; overflow: auto;'>",
    ...
    observeEvent(input$button_save_code, {
      ...
      if (!.check_project_options(paths())[["delete_possible"]] |
          .check_project_options(paths())[["update_possible"]]) {
        showNotification("Export of code unsucessful.\n
                         Project Structure needs to be created or updated beforehand.",
                         type = "error")
      } else {
        paths_in_directory = values$code_module$Filename

        if (input$checkbox_create_project_folder) {
          base_files = paths_in_directory[paths_in_directory %in% c(
            "app.R", "global.R", "ui.R", "server.R"
          )]
          
          www_files = paths_in_directory[paths_in_directory %in% c(
            "custom.css", "custom.js"
          )]
          www_files = paste("www", www_files, sep="/")
          
          if (input$checkbox_modules) {
            module_files = paths_in_directory[!paths_in_directory %in% c(
              "app.R", "global.R", "ui.R", "server.R", "custom.css", "custom.js"
            )]
            module_files = paste("modules", module_files, sep="/")            
          } else {
            module_files = c()
          }
          
          paths_in_directory = c(base_files, www_files, module_files)
          paths_in_directory = paste(basename(paths()[["project"]]), paths_in_directory, sep="/")
        }
